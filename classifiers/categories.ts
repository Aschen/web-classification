...
export const CATEGORIES_D: Categories = {
  ...
  descriptions: {
    ...
    other:
      "Content on an \"other\" category webpage within an Ecommerce website can be quite diversified. It may feature sections such as 'Contact Us', 'About Us', 'FAQ', 'Terms and Conditions', 'Privacy Policy', etc. On the 'Contact us' page, there could be details like email, phone numbers, contact forms, or live chat options. 'About Us' might provide the company’s history, mission, and team profiles. The 'FAQ' page might address common questions about products, shipping, or return policies. 'Terms and Conditions' could list out the rules and guidelines for using the site and 'Privacy Policy' would detail user data handling. These pages generally do not list any products for sale.",
    'page not found':
